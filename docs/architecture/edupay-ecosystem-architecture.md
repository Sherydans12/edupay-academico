...
| 1B. Académico → Financial Projection Contract | Académico, BL | Contrato, schemas, OpenAPI/documentación, fixtures y contract tests; sin productor/consumidor productivo | Retirar artefactos de contrato no desplegados sin datos de negocio |
...
El siguiente corte es **Fase 1B, diseño solamente**, también en worktree
propio:
