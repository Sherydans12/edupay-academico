...
| Académico — próximo cambio de esquema | Reconciliación anterior completada; el release DIE del 24/09 verificó el ledger de 13 migraciones. No hay autorización general para migraciones productivas ni divergencia nueva documentada. | Antes de futuros cambios de esquema, verificar ledger/checksums y ensayar la actualización en un clon con recuperación comprobada; seguir [rehearsal](../deployment/prisma-reconciliation-rehearsal.md). | Ensayo y recuperación documentados para el cambio concreto, con decisión y autorización específicas antes de una migración productiva. |
