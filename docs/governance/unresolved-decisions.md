...
| D-05 | Academic source-of-truth by field — [Proposed ADR-0015](../decisions/ADR-0015-edupay-source-of-truth-proposal.md); source checkout evidence and owner approval still required | Prevents sync from overwriting manual changes | EduPay integration owner | Phase 2 |
| D-06 | Sync mode, frequency, and conflict/reconciliation flow — [Proposed ADR-0016](../decisions/ADR-0016-edupay-sync-strategy-proposal.md); source capability evidence and owner approval still required | Determines worker, idempotency, and operational design | EduPay integration owner | Phase 2/5 |
