...
| D-05 | Academic source-of-truth by field — [Proposed ADR-0015](../decisions/ADR-0015-edupay-source-of-truth-proposal.md); source evidence is complete and explicit owner approval is still required | Prevents sync from overwriting manual changes | EduPay integration owner | Phase 2 |
| D-06 | Sync mode, frequency, and conflict/reconciliation flow — [Proposed ADR-0016](../decisions/ADR-0016-edupay-sync-strategy-proposal.md); source capability evidence is documented and explicit owner approval is still required | Determines worker, idempotency, and operational design | EduPay integration owner | Phase 2/5 |
