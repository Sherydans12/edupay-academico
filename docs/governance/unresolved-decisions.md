...
These resolutions do not close D-11, D-15, or D-16. Malware scanning, deletion, legal hold, export, cleanup, hosting, RTO/RPO, and provider support decisions remain open. D-05 and D-06 are accepted, but their source API and implementation prerequisites remain delivery gates.
