...
| --- | --- | --- |
| [0001](ADR-0001-service-and-database-boundary.md) | Independent academic service and database | Proposed / mostly mandated |
| [0002](ADR-0002-tenant-context-resolution.md) | Trusted tenant-context resolution | Proposed / mandatory security property |
| [0003](ADR-0003-identity-ownership-and-linking.md) | Identity ownership and optional academic links | Proposed / mostly mandated |
