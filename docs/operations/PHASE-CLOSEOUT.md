...
- Las propuestas documentales a main contienen solo documentación. No fusionar
  un release completo para resolver un cambio de README.
...
5. main Académico era anterior al código desplegado; las baselines y los SHAs
   explícitos evitan restaurarlo por error. BL mantiene auto deploy en main:
   revisar el comportamiento antes de fusionar y no cambiar pins implícitamente.
