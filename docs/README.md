...
10. [Academic → Financial Projection](integration/academic-financial-projection.md) for Phase 1B contract artifacts; producer and BL consumer remain disabled until Phase 1C
