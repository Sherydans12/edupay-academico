...
--
-- The historical versioning migration is restored in this candidate chain.
-- This migration therefore contains only the effects that were absent from
-- the production ledger after the authorised additive repair: body_document
-- columns and their deterministic compatibility backfill.
