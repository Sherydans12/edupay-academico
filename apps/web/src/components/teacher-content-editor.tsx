...
function initialFormState(
  item?: LearningItem | null,
  draft?: LearningItemDraft | null,
): ContentEditorFormState {
  if (draft) {
    return {
      ...
      bodyDocument:
        draft.bodyDocument ??
        item?.bodyDocument ??
        legacyTextToBodyDocument(draft.body ?? item?.body ?? ''),
  ...
  return {
    ...
    body: item?.body ?? '',
    bodyDocument:
      item?.bodyDocument ?? legacyTextToBodyDocument(item?.body ?? ''),
...
export function TeacherContentEditor({
  ...
  >('content');
  const [serverDraft, setServerDraft] = useState<LearningItemDraft | null>(
    null,
  );
  ...
  const prepareInput = (confirmSensitiveChange = false) => {
    const legacyBody = bodyDocumentToLegacyText(form.bodyDocument);
    return {
      type: form.type,
      title: form.title.trim(),
      description: form.description.trim() || undefined,
      content: form.type === 'MATERIAL' ? legacyBody || undefined : undefined,
      instructions: deliverable ? legacyBody || undefined : undefined,
      body: form.type === 'ANNOUNCEMENT' ? legacyBody || undefined : undefined,
      bodyDocument: form.bodyDocument,
      dueAt: deliverable
        ? learningDateTimeLocalToInstant(form.dueAt)
        : undefined,
    ...
    try {
      ...
      if (isPublished) {
        ...
        const draftInput = {
          ...
          content: form.type === 'MATERIAL' ? legacyBody || null : null,
          instructions: deliverable ? legacyBody || null : null,
          body: form.type === 'ANNOUNCEMENT' ? legacyBody || null : null,
          bodyDocument: form.bodyDocument,
          dueAt: deliverable
      ...
      if (err instanceof AcademicApiError && err.code === 'STALE_REVISION') {
        ...
        setConfirmation({
          body:
            err instanceof Error
              ? err.message
              : 'Publicar estos cambios puede alterar lo que ven los estudiantes o la evidencia registrada.',
  ...
  return (
    <>
      <div className="teacher-editor-layout">
        {/* Top Pinned Region */}
        <div className="teacher-editor-top-region">
          {/* Top Header */}
            ...
            <div className="teacher-editor-header__right">
              ...
              <div className="editor-status-indicators">
                ...
                <span className="dirty-indicator">
                  {saving ? (
                    <small className="dirty-indicator--saving">
                      <Icon name="clock" />
                      Guardando…
                    </small>
                  ) : isDirty ? (
                    <small className="dirty-indicator--dirty">
                      <span className="dirty-dot" />
                      Sin guardar
                    </small>
                  ) : lastSavedAt ? (
                    <small className="dirty-indicator--saved">
                      <Icon name="check" />
                      Guardado{' '}
            ...
            <div className="working-draft-banner">
              ...
              <div>
                ...
                <p>
                  ...
                  cambios solo serán visibles para el curso cuando pulses
                  «Publicar cambios».
                </p>
              </div>
              {serverDraft ? (
          ...
          {staleRevisionConflict ? (
            <Alert
              ...
              tone="warning"
            >
              Otro docente o pestaña guardó cambios en este contenido. Tus
              modificaciones locales siguen en la pantalla para que puedas
              copiarlas antes de actualizar.
            </Alert>
          ) : null}
        ...
        <div className="teacher-editor-scroll-body">
          <div className="teacher-editor-workspace">
            ...
            <main className="editor-main-panel">
              ...
              {activeTab === 'content' ? (
                <div className="editor-form-layout">
                  <div className="editor-form-fields">
                    ...
                    {!isPublished ? (
                      <div className="editor-schedule-quick-box">
                        <Input
                          hint={
                            form.publishAt
                              ? `Se programará para publicarse automáticamente el ${formatInstant(
                                  learningDateTimeLocalToInstant(
                                    form.publishAt,
                                  ) ?? '',
                                )}`
                              : 'Opcional. Deja este campo vacío si deseas publicar de inmediato o guardar como borrador.'
                          }
                          id="editor-publish-schedule-field"
                          label="Programar publicación para fecha futura (opcional)"
                          min={learningInstantToDateTimeLocal(
                            new Date().toISOString(),
                          )}
                          onChange={(event) =>
                            setForm({ ...form, publishAt: event.target.value })
                          }
                          type="datetime-local"
                        ...
                        {item ? (
                          ...
                          <Card className="editor-attachments-pending-notice">
                            <div className="pending-notice-row">
                              ...
                              <div>
                                <strong>
                                  Archivos adjuntos y material descargable
                                </strong>
                                <p>
                                  Podrás subir y gestionar archivos adjuntos una
                                  vez guardado el borrador inicial de este
                                  contenido.
                                </p>
                              </div>
                            </div>
                  ...
                  <aside className="editor-side-helper">
                    <Card className="editor-help-card">
                      ...
                      <div className="markdown-hints">
                        ...
                        <ul>
                          <li>
                            <code>**negrita**</code> o Ctrl+B
                          </li>
                          <li>
                            <code>*cursiva*</code> o Ctrl+I
                          </li>
                          <li>
                            <code>### Título de sección</code>
                          </li>
                          <li>
                            <code>- Viñeta</code> o <code>1. Número</code>
                          </li>
                        </ul>
                      </div>
                    </Card>
                    ...
                    <div className="section-heading">
                      <div className="section-heading-title">
                        ...
                        <div>
                          ...
                          <p>
                            Controla cuándo y cómo los estudiantes tienen acceso
                            a este contenido.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="settings-options">
                      {isPublished ? (
                        <div className="settings-published-box">
                          <div className="settings-box-icon">
                            <Icon name="check" />
                          </div>
                          <div className="settings-box-content">
                            <strong>
                              Este contenido está publicado y visible
                            </strong>
                            <p>
                              Los estudiantes del curso tienen acceso directo a
                              este material en su ruta de aprendizaje.
                            </p>
                            <div className="settings-box-actions">
                              <Button
                        ...
                        <div className="settings-schedule-box">
                          <div className="settings-schedule-intro">
                            <p>
                              Puedes programar una fecha y hora futura para que
                              el contenido pase automáticamente al estado{' '}
                              <strong>Publicado</strong> sin requerir
                              intervención manual.
                            </p>
                          </div>
                          <Input
                            hint="Si se deja vacío, el contenido permanecerá en borrador hasta que pulses «Publicar ahora»."
                            id="editor-publish-at"
                            label="Programar publicación automática (opcional)"
                            min={learningInstantToDateTimeLocal(
                              new Date().toISOString(),
                            )}
                            onChange={(event) =>
                      ...
                      <div className="section-heading">
                        <div className="section-heading-title">
                          ...
                          <div>
                            ...
                            <p>
                              Configura el límite temporal para que los
                              estudiantes envíen sus archivos o respuestas.
                            </p>
                          </div>
                        </div>
                        {form.dueAt ? (
                          ...
                          <Badge tone="neutral">Sin plazo límite</Badge>
                        )}
                      </div>

                      <div className="settings-options">
                        <Input
                          hint="Las entregas enviadas después de este plazo quedarán marcadas como atrasadas de forma automática."
                          id="settings-due-at"
                          label="Fecha y hora límite de entrega (opcional)"
                          onChange={(event) =>
                            setForm({ ...form, dueAt: event.target.value })
                          }
                          type="datetime-local"
              ...
              {activeTab === 'preview' ? (
                <div className="editor-preview-panel">
                  <div className="preview-indicator-bar">
                    ...
                    <small>
                      Esta es la apariencia exacta que experimentarán tus
                      estudiantes al abrir este contenido.
                    </small>
                  </div>
                  ...
                  <div className="assignment-layout">
                    <article className="assignment-content">
                      <div className="assignment-title">
                        ...
                        <p>
                          {form.description ||
                            'Descripción del contenido publicado para tu curso.'}
                        </p>
                      ...
                      {deliverable ? (
                        <section>
                          ...
                          <div className="learning-rich-text">
                            <BodyDocumentRenderer
                              document={form.bodyDocument}
                              fallbackText={form.instructions}
                            />
                          </div>
                        </section>
                      ) : null}
                      ...
                      {deliverable && form.dueAt ? (
                        <Alert title="Fecha de entrega" tone="warning">
                          ...
                          . La hora y la condición de atraso son calculadas
                          automáticamente.
                        </Alert>
                      ) : null}
                    </article>
              ...
              <div
                ...
                style={{ flexShrink: 0, height: '3rem', width: '100%' }}
              />
            </main>
          </div>
        </div>
        ...
        <footer className="teacher-editor-footer">
          ...
          <div className="editor-footer-right">
            ...
            >
              <Icon name="check" />
              {isPublished ? 'Publicar cambios' : 'Publicar ahora'}
            </Button>
          </div>
        </footer>
      </div>
        ...
        >
          <div>
            ...
            <p className="integration-note">
              <Icon name="layers" />
              El contenido volverá al estado de borrador. Las entregas y el
              historial de revisiones se conservan intactos.
            </p>
            <div className="showcase-dialog-actions">
              <Button
