              ...
              {selectedRevision ? (
                <>
                  ...
                  <p className="integration-note">
                    <Icon name="layers" />
                    Restaurar no elimina cambios posteriores. Se creará una
                    nueva versión con los datos de esta captura.
                  </p>
                  ...
                  <div className="snapshot-content">
                    ...
                    {selectedBodyDocument ? (
                      <div className="snapshot-field">
                        <strong>Contenido por bloques</strong>
                    ...
                    {selectedRevision.snapshot.dueAt ? (
                      <div className="snapshot-field">
                        ...
                        <p>
                          {formatDate(String(selectedRevision.snapshot.dueAt))}
                        </p>
                      </div>
                    ) : null}
