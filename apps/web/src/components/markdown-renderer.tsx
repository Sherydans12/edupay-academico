...
export function MarkdownRenderer({
  ...
  while (i < lines.length) {
    ...
    if (trimmed.startsWith('# ')) {
      blocks.push(
        <h1 className="markdown-h1" key={`h1-${i}`}>
    ...
    if (trimmed.startsWith('## ')) {
      blocks.push(
        <h2 className="markdown-h2" key={`h2-${i}`}>
    ...
    if (trimmed.startsWith('### ')) {
      blocks.push(
        <h3 className="markdown-h3" key={`h3-${i}`}>
    ...
    if (trimmed.startsWith('#### ')) {
      blocks.push(
        <h4 className="markdown-h4" key={`h4-${i}`}>
    ...
    if (trimmed.startsWith('> ') || trimmed === '>') {
      ...
      while (
        ...
        quoteLines.push(
          qLine.startsWith('> ') ? qLine.slice(2) : qLine.slice(1),
        );
        i++;
      }
      blocks.push(
