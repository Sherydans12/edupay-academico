        ...
        {data ? (
          <>
            ...
            <div className="teacher-dashboard-grid">
              ...
              <section
                aria-labelledby="teacher-route-title"
                className="content-section teacher-review-queue"
              >
              ...
              <aside className="week-plan">
                ...
                <p>
                  Reúne las entregas pendientes, el historial y las revisiones
                  de tus asignaturas.
                </p>
                <Link
                  ...
                  content: (
                    <Card className="team-panel">
                      ...
                      <div>
                        ...
                        <small>
                          Los docentes asignados comparten este espacio de
                          trabajo.
                        </small>
                      </div>
                    </Card>
...
function useTeacherReviewWorkspace(api: AcademicApiClient) {
  const [contexts, setContexts] = useState<
    Array<{ subject: CourseSubject; items: LearningItem[] }>
  >([]);
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState<unknown>(null);
              ...
              >
                ...
                <div className="learning-items">
                  {group.rows.map((entry) => (
                    ...
                    >
                      <span
                        className={`learning-item__icon ${entry.type === 'DUE' ? 'learning-item__icon--assignment' : ''}`}
                      >
                        <Icon
                          name={
                            entry.type === 'DUE'
