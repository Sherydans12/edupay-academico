  ...
  it('renders the enrollment and assignment workflows for academic structure', async () => {
    ...
    expect(
      await screen.findByRole('heading', {
        name: 'Inscripciones y asignaciones',
      }),
    ).toBeTruthy();
    expect(
      screen.getByRole('heading', { name: 'Asignar docente a CourseSubject' }),
    ).toBeTruthy();
    expect(
      screen.getByRole('heading', { name: 'Asignar subject directamente' }),
    ).toBeTruthy();
  });
